...
<head>
  ...
  <title>Nukhba — Tutoring Platform</title>
  <meta name="description" content="Free nonprofit tutoring platform for K-12 students" />
...
{
  "name": "Nukhba Tutoring Platform",
  "short_name": "Nukhba",
  "description": "Free nonprofit K-12 tutoring platform",
  "start_url": "/",
  "display": "standalone",
...
const CACHE = 'nukhba-v1';
const ASSETS = ['/', '/index.html', '/styles/main.css', '/app.js', '/manifest.json'];
